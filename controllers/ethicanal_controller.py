...
from services.ethicanal_service import analyze_comment
...
def analyze():
    ...
    This function extracts the comment JSON from the request, analyzes it using the analyze_comment
    ...
    try:
        ...
        ethicanal = analyze_comment(comment_json)
